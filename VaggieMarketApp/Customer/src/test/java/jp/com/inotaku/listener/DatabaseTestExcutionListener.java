package jp.com.inotaku.listener;
...
public class DatabaseTestExcutionListener implements TestExecutionListener{
	...
	public void beforeTestMethod(TestContext testContext) throws Exception {
		...
		if(!dataSetName.equals("")){
			databaseTester = (IDatabaseTester)testContext.getApplicationContext()
			...
			IDataSet dataSet = new XlsDataSet(new File(dataSetName));
