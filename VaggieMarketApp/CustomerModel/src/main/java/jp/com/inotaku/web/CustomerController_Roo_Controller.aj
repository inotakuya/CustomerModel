...
import jp.com.inotaku.web.CustomerController;
...
privileged aspect CustomerController_Roo_Controller {
    ...
    @Autowired
    CustomerAttributeService CustomerController.customerAttributeService;
    ...
    void CustomerController.populateEditForm(Model uiModel, Customer customer) {
        ...
        uiModel.addAttribute("customerattributes", customerAttributeService.findAllCustomerAttributes());
    }
